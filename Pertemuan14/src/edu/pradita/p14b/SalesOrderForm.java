...
public class SalesOrderForm extends JPanel implements IForm {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					for (int i = 0; i < table.getRowCount(); i++) {
						...
						// update the stock
						statement = MainForm.CONNECTION.prepareStatement("UPDATE item SET quantity = quantity - ? " + "WHERE code = ?;");
	...
	private void displayOrder(PreparedStatement statement) throws SQLException {
		...
		if (resultSet.next()) {
			...
			statement = MainForm.CONNECTION.prepareStatement("select line, itemcode, name, price, quantity, (quantity * price) total "
